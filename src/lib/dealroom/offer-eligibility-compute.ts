// ═══════════════════════════════════════════════════════════════════════════
// Offer Eligibility Computation (KIN-822)
//
// Pure, deterministic computation of whether a buyer is eligible to make an
// offer on a given deal room from a snapshot of their agreements. No DB, no
// auth, no side effects — suitable for unit tests and for running from both
// the Next.js app and Convex functions.
//
// NOTE: There is a Convex-side mirror of this file at
// `convex/lib/offerEligibilityCompute.ts`. The Convex tsconfig cannot import
// from `../src`, so the two files must be kept in sync manually. Any change
// here MUST be mirrored there and vice versa. The shape is small enough that
// tests on either side cover both.
// ═══════════════════════════════════════════════════════════════════════════
