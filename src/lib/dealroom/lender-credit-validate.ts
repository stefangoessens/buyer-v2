...
//
// Pure TypeScript. Used by both the Convex backend and future frontend
// surfaces that need to preview validation before writing state.
//
...
// `convex/lib/lenderCreditValidate.ts`. The Convex tsconfig cannot import
// from `../src`, so the pure computation logic has to live twice. Any
