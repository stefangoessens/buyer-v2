...
export const metadata: Metadata = {
  title: "Create account | buyer-v2",
  description:
    "Create your free buyer-v2 account to get AI-powered Florida home analysis, fair pricing, and expert buyer representation.",
};
          ...
          <div className="w-full max-w-[440px]">
            <div className="mb-8 text-center">
              ...
              <p className="mt-3 text-[15px] leading-[1.5] text-neutral-500">
                Get instant AI analysis on any Florida listing — no credit card
                required.
              </p>
            </div>
