...
interface InspectionUploadPanelProps {
...
export function InspectionUploadPanel({
  dealRoomId,
  propertyId,
  nextPacketVersion,
  isReplacement = false,
  ...
  const handleUpload = useCallback(async () => {
    ...
    setError(null);
    setUploading(true);
    trackInspectionEvent("PACKET_UPLOAD_STARTED", {
      dealRoomId,
      propertyId,
    ...
    try {
      ...
      trackInspectionEvent("PACKET_UPLOAD_COMPLETED", {
        dealRoomId,
        propertyId,
        packetVersion: nextPacketVersion,
  ...
  const headlineId = "inspection-upload-heading";

  return (
    <Card
      className="rounded-4xl border-border"
      data-testid="inspection-upload-panel"
    >
      <CardContent className="flex flex-col gap-6 p-6 sm:p-8">
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
            {isReplacement ? "Upload new version" : "Inspection report"}
          </p>
          <h2
            id={headlineId}
          ...
          >
            {isReplacement
              ? "Replace the inspection packet"
              : "Upload your inspection report"}
          </h2>
          <p className="text-sm text-muted-foreground">
            PDFs or photos of every inspection report your inspector shared.
            We&apos;ll extract the text, surface big-ticket items, and explain
        ...
        <div
          ...
          data-testid="inspection-drop-zone"
        >
          ...
          <div className="flex flex-col gap-1">
            <p className="text-base font-medium text-foreground">
              {isMobile
                ? "Add the report from your phone"
                : "Drag PDFs or photos here"}
            </p>
          ...
          <input
            ...
            capture="environment"
            onChange={handleFileInputChange}
            data-testid="inspection-camera-input"
          />
        </div>
