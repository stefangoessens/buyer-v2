...
export default defineSchema({
  ...
  properties: defineTable({
    ...
    // KIN-1072: Broward PAPA enrichment
    ...
    papaTaxableValue: v.optional(v.number()),
    papaExemptions: v.optional(v.array(v.string())),
    papaLastSalePrice: v.optional(v.number()),
    papaLastSaleDate: v.optional(v.string()),
    papaTaxBillTotal: v.optional(v.number()),
    papaLookupAt: v.optional(v.string()),
